...
def extract_duties_and_requirements_by_keywords(text):
    text = text.replace('\u200b', '').replace('<strong>', '').replace('</strong>', '').replace('<em>', '').replace('</em>', '').replace('<span>', '').replace('</span>', '').replace(';', '').replace('·', '').replace('●', '').replace('✔️', '').replace('✅', '').replace('⭐️', '').replace('🧩', '').replace('🔹', '')
