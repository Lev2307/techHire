...
def generate_appropriate_vacancy_data(external_id, title, reqs, duties, work_cond, payment_from, payment_to, currency, work_formats, experience, date_published, is_added_to_favorites, initial_source, employer_name, employer_address, employer_url) -> dict:
    return {
        'external_id': external_id,
        'title': title,
        'requirements': reqs,
        'duties': duties,
        'working_conditions': work_cond,
        'payment': {
