...
def extract_duties_and_requirements_by_keywords(text):
    ...
    '''
    text = text.replace('<strong>', '').replace('</strong>', '').replace('<em>', '').replace('</em>', '').replace(';', '').replace('·', '').replace('—', '')
