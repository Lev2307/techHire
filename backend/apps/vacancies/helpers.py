...
def generate_appropriate_vacancy_data_for_search_response(pk, title, reqs, duties, work_cond, payment_from, payment_to, currency, work_formats, date_published, is_added_to_favorites, initial_source, employer_name, employer_url) -> dict:
    return {
        'id': pk,
        'title': title,
        'requirements': reqs,
