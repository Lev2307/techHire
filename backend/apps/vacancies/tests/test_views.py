...
class VacanciesViewsTests(TestCase):
    ...
    #         }
    #     )
    #     self.assertEqual(response.url, reverse("vacancies:search_vacancies", query={'query': self.query_for_latest_hh_request, 'payment_from': self.payment_from_for_latest_hh_request}))
